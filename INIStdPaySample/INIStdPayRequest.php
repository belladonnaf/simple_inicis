...
$siteDomain = site_url().'/wp-content/plugins/simple_inicis/INIStdPaySample'; //가맹점 도메인 입력
...
<html>
    ...
    <body bgcolor="#FFFFFF" text="#242424" leftmargin=0 topmargin=15 marginwidth=0 marginheight=0 bottommargin=0 rightmargin=0>
        ...
        <table width="650" border="0" cellspacing="0" cellpadding="0" style="padding:10px;display:none !important" align="center">
            <tr>
                                    ...
                                    <tr>
                                        <td style="text-align:left;">
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input style="width:100%;" name="payViewType" value="popup" >
...
/-->
			  ...
			  <input type="hidden" name="merchantData" value="<? echo base64_encode($merchantData)?>">
	        </form>
        <button onclick="pay()">결제요청</button>
<script>
setTimeout('pay()',1000);
</script>
    </body>
